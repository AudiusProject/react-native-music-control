...
public class MusicControlNotification {
    ...
    public synchronized void updateActions(long mask, Map<String, Integer> options) {
        ...
        if (options != null && options.containsKey("skipForward") && (options.get("skipForward") == 10 || options.get("skipForward") == 5 || options.get("skipForward") == 15 || options.get("skipForward") == 30)) {
        ...
        if (options != null && options.containsKey("skipBackward") && (options.get("skipBackward") == 10 || options.get("skipBackward") == 5 || options.get("skipBackward") == 15 || options.get("skipBackward") == 30)) {
